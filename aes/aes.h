...
private:
    ...
    static constexpr uint8_t SBOX_INV[][16] = {
    ...
    static constexpr uint8_t GALOI_MUL_TABLE[][256] = {
        ...
        // x * 0x9 = table[x] (GF(256))
        // Used in AES decryption (MixColumnsInv())
        {
