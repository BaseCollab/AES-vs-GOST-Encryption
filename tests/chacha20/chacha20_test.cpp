...
TEST(ChaCha20Test, Block)
{
    ...
    uint8_t block[Cipher::kBlockSize] = {};
    uint8_t refer[Cipher::kBlockSize] = {0x10, 0xf1, 0xe7, 0xe4, 0xd1, 0x3b, 0x59, 0x15,
    ...
    Cipher cipher;
    cipher.Block(key, 1, nonce, block);

    ASSERT_TRUE(memcmp(block, refer, sizeof(block)) == 0);
}
