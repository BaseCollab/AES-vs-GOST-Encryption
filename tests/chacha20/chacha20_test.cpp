...
TEST(ChaCha20Test, StateInit)
{
    ...
    Nonce nonce{0x00, 0x00, 0x00, 0x09,
                0x00, 0x00, 0x00, 0x4a,
                0x00, 0x00, 0x00, 0x00};
...
TEST(ChaCha20Test, Block)
{
    ...
    uint8_t block[Cipher::kBlockSize] = {0x10, 0xf1, 0xe7, 0xe4, 0xd1, 0x3b, 0x59, 0x15,
...
TEST(ChaCha20Test, Encrypt)
{
    ...
    Nonce nonce{0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x4a,
                0x00, 0x00, 0x00, 0x00};

    char plaintext[115] = "Ladies and Gentlemen of the class of '99: "
    ...
    uint8_t ciphertext[114] = {0x6e, 0x2e, 0x35, 0x9a, 0x25, 0x68, 0xf9, 0x80,
